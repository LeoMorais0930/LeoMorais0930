...
<p align="center">
  Trabalho principalmente com backends em .NET, integracoes, automacao de processos e interfaces web.
  Nos ultimos tempos venho desenvolvendo solucoes internas para a VETTI, projetos como Lunna e experiencias web mais caprichadas.
</p>
...
- Atualmente trabalhando em sistemas internos, produtos digitais e sites com foco em clareza, utilidade e acabamento.
...
**Lunna**<br>
Projeto recente em que venho trabalhando produto, experiencia de uso e organizacao de funcionalidades com foco em uma interface clara, bonita e simples de evoluir.

**Site para advocacia penal**<br>
Landing page premium para escritorio de advocacia, criada com React, Vite, GSAP e lucide-react, com foco em responsividade, motion design, navegacao direta, areas de atuacao, FAQ e contato.

**APIs e automacoes**<br>
Projetos menores e estudos envolvendo C#, ASP.NET Core, endpoints REST, organizacao de dados, scripts PowerShell, deploy local/servidor e paginas web sob medida.
